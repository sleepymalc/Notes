...
\end{algorithm}
\begin{note}
	The result of \hyperref[algo:random-walk-algorithm]{random walk} records the time the \hyperref[def:random-walker]{random walker} arrives \(v\) for all \(v\in \mathcal{\MakeUppercase{v}} \) throughout the simulation.
\end{note}
