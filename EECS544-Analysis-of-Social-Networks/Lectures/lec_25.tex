...
\begin{algorithm}[H]\label{algo:Hopcroft-Karp-algorithm}
	...
	\(\mathcal{\MakeUppercase{P}} \gets \{P_i\}_{i=1}^k\)\label{algo:Hopcroft-Karp-algorithm:line3}\Comment*[r]{Maximal set of \hyperref[def:vertex-independent]{disjoint} shortest \hyperref[def:augmenting-path]{augmenting paths} w.r.t. \(M\)}
