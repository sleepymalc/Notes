...
From the \autoref{thm:spectral-theorem}, let the eigenvectors of \(A A^{\top} \) be \(u_1, \ldots , u_{\left\vert \mathcal{\MakeUppercase{v}} \right\vert } \), then
\[
