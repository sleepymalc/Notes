...
\begin{note}
	For a \hyperref[def:set-system]{set system} \((\Omega , \mathcal{\MakeUppercase{S}} )\), we often let \(m\coloneqq \left\vert \mathcal{\MakeUppercase{S}}  \right\vert \) and \(n\coloneqq \left\vert \Omega  \right\vert \).
\end{note}
