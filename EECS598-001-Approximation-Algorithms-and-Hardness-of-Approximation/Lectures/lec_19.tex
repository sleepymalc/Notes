...
As mentioned, there's lots of \hyperref[def:reduction]{reduction} can be done between fundamental problems considered in TCS to \hyperref[prb:CSP]{CSP}, we now see some important result. In order to do this, we need a more fine-grained version of \autoref{def:gap}.
