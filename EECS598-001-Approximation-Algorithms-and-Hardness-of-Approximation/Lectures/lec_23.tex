...
\]
Although this is nice and is what we want, but to do the full reduction from \hyperref[prb:label-cover]{label cover} to \hyperref[prb:max-3LIN]{3LIN}, we will need to do additional works with \hyperref[prb:unique-game]{unique games}.
