...
Consider we have rolls of paper of width \(W\), with the demand widths being \(w_1, w_2, \dots , w_m < W\) and demands being \((\mathrm{D})\), which is usually pretty big. The goal is to use as few stock rolls as possible.
\end{problem}
\begin{answer}
