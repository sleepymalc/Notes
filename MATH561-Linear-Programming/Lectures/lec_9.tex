...
\begin{algorithm}[H]\label{algo:simplex-algorithm}
	...
	\KwResult{\hyperref[def:optimal-solution]{optimal solutions} \(\overline{x}, \overline{y}\), or report \textsf{\((P)\) is unbounded/infeasible}}
	...
	\uIf{\result \(=\) \textsf{unbounded}}{
		\Return{\textsf{\((P)\) has no solution}}
	}
	\Else{
