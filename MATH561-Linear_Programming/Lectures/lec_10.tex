...
\begin{theorem}[Complementary with equal objective value]\label{complementary with equal objective value}
...
\begin{theorem}[Weak complementary slackness theorem]\label{Weak Complementary Slackness}
...
\begin{theorem}[Strong complementary slackness theorem]\label{Strong Complementary Slackness}
