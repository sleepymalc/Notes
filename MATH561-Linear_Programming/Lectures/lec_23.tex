...
\begin{algorithm}[H]\label{algo:branch-and-bound-algorithm}
	...
	\KwResult{\hyperref[def:optimal-solution]{optimal solution} \(\overline{y}\) and \hyperref[def:optimal-solution]{optimal} value, or report \texttt{\((D_{\mathcal{\MakeUppercase{i}} } )\) is infeasible}}
