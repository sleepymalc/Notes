...
\begin{algorithm}[H]\label{algo:simplex-algorithm}
	...
	\KwResult{\hyperref[def:optimal-solution]{optimal solutions} \(\overline{x}, \overline{y}\) or report \texttt{\((P)\) is unbounded}, or report \texttt{\((P)\) has no solution}}
