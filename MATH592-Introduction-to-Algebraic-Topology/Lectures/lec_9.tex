...
\begin{corollary}[The fundamental group of \(S^k\)]
	The torus \(T\cong S^{1}\times S^1\) has \hyperref[def:fundamental-group]{fundamental group} \(\pi _1(T)\cong \mathbb{Z} ^2\). Additionally, for a \(k\)-torus
	\[
		\underbrace{S^{1}\times S^1 \times \dots \times S^1}_{k\text{ times}} = (S^1)^k,
	\]
	the \hyperref[def:fundamental-group]{fundamental group} is then \(\mathbb{Z} ^k\), i.e.
	\[
