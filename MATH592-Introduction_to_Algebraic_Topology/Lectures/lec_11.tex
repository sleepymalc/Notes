...
\begin{explanation}
	...
	\end{remark}
\end{explanation}
\begin{eg}[Fundamental group of torus.]\label{lec11:eg:torus}
	We now find the \hyperref[def:fundamental-group]{fundamental group} of a torus.
\end{eg}
\begin{explanation}
...
\begin{exercise}
	...
	\[
		\pi _1(X)\simeq F_n.
	\]
	One way to do this is to convince yourself that you can do a \hyperref[def:deformation-retraction]{deformation retract} the plane onto the following \hyperref[CW-complex-wedge-sum]{wedge}.
	\begin{figure}[H]
		\centering
		\incfig{lec11:ex}
