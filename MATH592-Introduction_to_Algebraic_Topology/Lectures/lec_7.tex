...
Specifically, we care about two \hyperref[def:functor]{functor}.
\begin{enumerate}
	\item
	      \[
		      \begin{split}
...
\begin{definition}[Adjoints functor]\label{def:adjoint-functor}
	A \hyperref[eg:free-functor]{\underline{free}} and \hyperref[eg:forgetful-functor]{\underline{forgetful}} functors are \emph{adjoints}.
\end{definition}
