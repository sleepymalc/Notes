...
\begin{theorem}[Riesz-Fischer theorem]\label{thm:Riesz-Fischer}
		      ...
		      \begin{enumerate}
			      ...
			      \item We then show the last condition we need to check.
			            ...
			            \begin{explanation}
				            ...
				            \]
				            Since \(2G\in L^p\), so \(2G^p\in L^1\). Thus, by \hyperref[thm:DCT]{dominated convergence theorem}, we have
				            \[
