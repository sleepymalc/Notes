...
\begin{definition*}
	...
	\begin{definition}[Positive variation measure]\label{def:positive-variation-measure}
		\(\nu ^+\) is the \emph{positive variation measure} of \(\nu \).
	\end{definition}

	\begin{definition}[Negative variation measure]\label{def:negative-variation-measure}
