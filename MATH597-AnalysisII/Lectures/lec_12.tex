...
\begin{corollary}[Tonelli's theorem for series and integrals]\label{thm:Tonelli-theorem-for-series-and-integrals}
...
\begin{corollary}
	...
	\begin{enumerate}
		\item
		      ...
		      \]
		\item \(\lim\limits_{n \to \infty} f_{n} = f\ \hyperref[def:mu-almost-everywhere]{a.e.} \implies \int f \leq \liminf_{n \to \infty} \int f_{n}\).
	\end{enumerate}
\end{corollary}
\begin{proof}
	\todo{DIY}
