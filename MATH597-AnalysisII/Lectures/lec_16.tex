...
\begin{lemma}
	We have
	\[
		f_{n}\to f \text{ \hyperref[def:uniformly-convergence]{uniformly} on } S \iff \exists N_1, N_2, \dots\in \mathbb{N}\ S\subset \bigcap\limits_{k=1}^{\infty} \bigcap\limits_{n=N_k}^{\infty} B_{n, k}.
	\]
\end{lemma}
...
\begin{notation}
	We denote \(I = \{1, \dots , d\} \implies X = \prod\limits_{i=1}^{d} X_{i}, x = (x_1, \dots , x_d )\). Also,
	\[
