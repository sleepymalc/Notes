...
\begin{proof}
	...
	\begin{enumerate}
		\item Note that for \(f\colon Y\to Z\), and \(\mathcal{\MakeUppercase{b}} \) be a \hyperref[def:sigma-algebra]{\(\sigma\)-algebra} on \(Z\), then
		      \(f^{-1} (\mathcal{\MakeUppercase{b}} )\) is also a \hyperref[def:sigma-algebra]{\(\sigma\)-algebra}.\footnote{Since \(f^{-1} (\varnothing ) = \varnothing\), \(f^{-1} (B)^{c} = f^{-1} (B^{c} )\), and \(\bigcup\limits_{n} f^{-1} (B_{n}) = f^{-1} (\bigcup\limits_{n}B_{n} )\).}
