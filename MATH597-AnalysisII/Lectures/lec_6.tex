...
We can actually show the uniqueness of HK extension.

\begin{theorem}[Uniqueness of HK extension]\label{thm:uniqueness-of-HK-extension}
	Let \(\mathcal{A}_0\) be an algebra on \(X\), \(\mu _0\) be a pre-measure on \(\mathcal{A} _0\). Let \((\mathcal{A} , \mu)\)
...
\begin{proof}
	...
	\begin{itemize}
		\item \label{pf:uniqueness-of-HK-extension-2.i}Assume \(\mu (A)<\infty \), and fix \(\epsilon >0\). Then there exists \(B_{i}\in\mathcal{A} _0\) with \(B\coloneqq \bigcup\limits_{i=1}^{\infty} B_{i}\supset A\)
		      ...
		      On the other hand,
		      \[
			      \mu (B) = \lim\limits_{N \to \infty} \mu \left(\bigcup\limits_{i=1}^{N} B_{i}\right) =\footnotemark \lim\limits_{N \to \infty} \mu ^\prime \left(\bigcup\limits_{i=1}^{N} B_{i}\right) = \mu ^\prime (B),
		      \]
		      hence,
		...
		\item Assume \(\mu (A) = \infty \). Since \(\mu _0\) is \(\sigma \)-finite, so we know \(X = \bigcup\limits_{n=1}^{\infty} X_{n}\) for some \(X_{n}\in\mathcal{A} _0\) such that
		      \[
			      \mu _0(X_{n})<\infty.
		      \]
