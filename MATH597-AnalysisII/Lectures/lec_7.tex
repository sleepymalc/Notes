...
\begin{proof}
	...
	\begin{enumerate}
		...
		\item \(\mu _0\) is \hyperref[def:pre-measure-countable-additivity-within-the-algebra]{countable additivity within \(\mathcal{H}\)}.
		      ...
		      \end{claim}
		      \begin{explanation}
			      Since \((a, b]\supset \bigcup\limits_{n=1}^{N} (a_{n}, b_{n}]\) for any fixed \(N\in\mathbb{\MakeUppercase{N}} \), hence
			      \[
		      ...
		      \end{claim}
		      \begin{explanation}
			      Fix \(\epsilon >0\). Since \(F\) is right-continuous, \(\exists a ^\prime > a\) such that
			      \[
