...
and so on. This is so-called \emph{Cantor Function}. We can show \(F\) is continuous and increasing, which makes \(F\) a distribution function.\todo{HW}
...
\begin{table}[H]
	...
	\begin{tabular}{lcl}
		\toprule
		Cantor Measure \(\mu _F\)                              &           & Lebesgue Measure \(m\)                                  \\
		\midrule
