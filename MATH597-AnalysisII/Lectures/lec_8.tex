...
To classify all measure, we now see this last theorem to complete the task.
\begin{theorem}[Locally finite Borel measures on \(\mathbb{\MakeUppercase{r}} \)]
	We have
	\begin{enumerate}
...
\begin{lemma}
	...
	\footnotetext{This follows from the continuity of measure.}
\end{lemma}
