...
\begin{proof}
	...
	\[
		...
		\end{dcases}
	\]
	where \(\{r_1, r_2, \ldots  \}= \mathbb{Q} \), and
	\[
...
\begin{proof}
	...
	\begin{enumerate}[(1)]
		...
		\item Now, we show \(\mu _{F}(\mathbb{R} \setminus \mathbb{Q} ) = 0\). Firstly, we claim that
		      ...
		      \[
			      \mathbb{R} = \lim\limits_{N \to \infty} \bigcup\limits_{i=1}^{N} (a-i, a+i]
		      \]
		      for any \(a\in\mathbb{R} \), say \(0\). From \hyperref[thm:measure-space-continuity-from-below]{continuity from below}, we have
		      \[
			      \mu _{F}\left(\bigcup\limits_{i=1}^{\infty} (-i, +i]\right) = \lim\limits_{n \to \infty} \mu _{F}((-n, n]) = \sum\limits_{n;r_{n}\in\mathbb{Q} }\frac{1}{2^n} = 1.
		      \]
