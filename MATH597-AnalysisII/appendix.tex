...
\begin{proof}
	...
	\paragraph{Claim.} If \(A\subset X\) satisfies \(\mu ^{*} (A) = 0\), then \(A\) is \hyperref[def:C-measurable]{Carathéodory measurable} with respect to \(\mu ^{*} \).
	...
	\paragraph{Claim.} If \(A\) is \hyperref[def:mu-subnull-set]{\(\mu\)-subnull}, then \(A\in \mathcal{\MakeUppercase{a}} \).
	\begin{mdframed}[skipabove=0.1in,skipbelow=0.1in]
		\begin{proof}
