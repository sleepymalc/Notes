...
\[
	\left\{ x\in X\colon \left\vert f_k(x - x_0) \right\vert < \epsilon ,f_k\in X^{\ast}, \epsilon > 0, k = 1, 2, \ldots , N \right\}
\]
...
\begin{explanation}
	...
	\[
		X\to \mathbb{R} ^{\infty} ,
		\quad x\mapsto (f_k(x))_{f_k\in X^{\ast}} = (f_1(x), f_2(x), \ldots ),
	\]
