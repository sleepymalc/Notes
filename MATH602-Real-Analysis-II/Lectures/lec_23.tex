\lecture{23}{17 Nov. 14:30}{The Spectrum Interval}
...
\begin{definition}[Polynomials of an operator]\label{def:polynomials-of-an-op}
...
\subsection{Spectral Mapping Theorem for Polynomials}
...
\begin{corollary}[Operator norm of polynomials]\label{col:op-norm-of-polynomials}
