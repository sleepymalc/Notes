...
\begin{eg}[Canonical basis of \(\ell _2\)]
	In the space \(\ell _2\), \(x_{k} = (0, 0, \ldots , 1 , 0, \ldots , 0 )\in \ell _2\) for \(k = 1, 2, \ldots\) is an \hyperref[def:orthonormal-system]{orthonormal system} in \(\ell _2\) forming a basis.
\end{eg}
