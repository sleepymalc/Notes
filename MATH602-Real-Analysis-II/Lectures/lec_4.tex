...
\begin{definition}[Orthonormal system]\label{def:orthonormal-system}
	A \hyperref[def:orthogonal-system]{orthogonal system} is called an \emph{orthonormal system} if in addition, we have \(\left\lVert x_{k} \right\rVert= 1 \) for \(k = 1, 2, \ldots  \).
\end{definition}
