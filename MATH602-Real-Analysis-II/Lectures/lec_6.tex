...
Another useful application of \autoref{thm:Riesz-representation} is to characterize \(L^p\) and \(\ell _p\) spaces and their \hyperref[def:dual-space]{dual} \(L^{\ast} _p\) and \(\ell ^{\ast} _p\). We first see the following.
\begin{remark}
