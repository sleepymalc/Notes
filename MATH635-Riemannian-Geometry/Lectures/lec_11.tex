...
A \hyperref[def:Riemannian-metric]{Riemannian metric} induces bundle metrics on all tensor bundle s over \(\mathcal{M} \). Metric of \(T^{\ast} \mathcal{M} \) given by
\[
