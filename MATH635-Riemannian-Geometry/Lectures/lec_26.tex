\lecture{26}{11 Apr. 13:00}{}\todo{This lecture we use \(\dim \mathcal{M} = m\), change it back to \(n\).}
\begin{corollary}
...
\begin{proof}
	...
	\]
	for a comparison \hyperref[def:geodesic-hinge]{geodesic hinge} \(\angle \widetilde{q} _1 \widetilde{p} \widetilde{q} \) in \(\mathcal{M} _k^m= S^m(1 / \sqrt{k} )\). Now, sue the cosine law for \(S^m(1 / \sqrt{k} )\),
	\[
