...
\end{lemma}
\begin{proof}
	In the local coordinates \((z^1, \dots , z^n)\) on \(\mathcal{N} \), and \((x^1, \dots , x^m)\) on \(\mathcal{M} \), without loss of generality,\footnote{Since \(\mathrm{d} f(x)\) is injective.} let
	\[
