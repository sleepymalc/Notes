...
\begin{definition}[Vector field along a curve]\label{def:vector-field-curve}
...
\begin{notation}[Christoffel symbol]
...
In other words, from \autoref{prop:Euler-Lagrange-eq-geodesic}, we naturally define \hyperref[def:geodesic]{geodesic} by the solution of \autoref{eq:geodesic}, which is the critical points of \hyperref[def:energy]{energy}.
