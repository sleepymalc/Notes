...
\begin{prev}
	\(\ACF\), \(\DLO\), and also the \hyperref[def:random-graph-theory]{random graph theory}.\footnote{This is very similar to the arguement we gave for \(\DLO\).}
\end{prev}
