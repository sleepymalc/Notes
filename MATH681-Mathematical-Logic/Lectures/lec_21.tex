\lecture{21}{23 Mar.\ 11:30}{Proof of Fraïssé Theorem}
\begin{prev}
...
\begin{lemma}
	Let \(\mathbb{K} \) have the \hyperref[def:AP]{amalgamation property}. Then for \(\mathcal{B} , \mathcal{A} _1, \dots , \mathcal{A} _n, \mathcal{C} _1, \dots , \mathcal{C} _n \in \mathbb{K} \) with \hyperref[def:embedding]{embeddings} % https://q.uiver.app/?q=WzAsMyxbMSwxLCJcXG1hdGhjYWx7QX1faSJdLFsyLDAsIlxcbWF0aGNhbHtDfV9pIl0sWzAsMCwiXFxtYXRoY2Fse0J9Il0sWzAsMiwiZl9pIl0sWzAsMSwiZ19pIiwyXV0=
	\(\begin{tikzcd}
	...
	\[\begin{tikzcd}
			& {\mathcal{D}} \\
			{\mathcal{B}} && {\mathcal{C}_1} & {\mathcal{C}_2} & {\mathcal{C}_3} & \dots \\
...
\begin{proof}[Proof of \autoref{thm:Fraisse}]
	...
	For the backward direction, we'll build \(\mathcal{M} _0 \subseteq \mathcal{M} _1 \subseteq \dots \) as in \hyperref[thm:baby-Fraisse]{baby Fraïssé theorem} to ensure \(\mathcal{M} \) obeys countably many ``conditions''. A ``condition'' means:
	\begin{itemize}
	...
	\[
		\left( \mathcal{A} _0, (\mathcal{A} _1, \mathcal{B} , g_1), \mathcal{A} _2, (\mathcal{A} _3, \mathcal{B} _3, g_3), \dots  \right)
	\]
	...
	\[\begin{tikzcd}
			...
			{\mathcal{M}_0} & {\mathcal{M}_1} & {\mathcal{M}_2} & {\mathcal{M}_3} & {\mathcal{M}_4} & \dots & {\mathcal{M}=\bigcup_n \mathcal{M}_n} \\
