...
\begin{definition}[Full theory]\label{def:full-theory}
	The \emph{full theory} \(\Th(\mathcal{M} ) \) of an \hyperref[def:structure]{\(\mathcal{L} \)-structure} \(\mathcal{M} \) is defined as \(\Th(\mathcal{M} ) = \left\{ \varphi \mid \mathcal{M} \models \varphi  \right\}\).
\end{definition}

From the definition, \(\mathcal{M} \models \Th(\mathcal{M} ) \), and \(\Th(\mathcal{M} ) \) characterizes the \hyperref[def:structure]{structures} satisfying the same \hyperref[def:sentence]{sentences} as \(\mathcal{M} \).
...
\begin{remark}
	\(\Th(\mathcal{M} ) \) is \hyperref[def:theory-complete]{complete}.
\end{remark}
...
\begin{remark}[Non-standard model of arithmetic]\label{rmk:non-standard-model-of-arithmetic}
	There are \(\mathcal{N} \models \Th(\mathbb{N})\), but \(\mathcal{N} \) is not isomorphic to \(\mathbb{N} \). \(\mathcal{N} \) is called a \emph{non-standard model of arithmetic}, and \(\mathcal{N} \) might have \emph{infinite element} larger than all of \(\mathcal{M} \). Here, \(\mathbb{N} =(\mathbb{N} , 0, 1, +, \cdot, - )\)
\end{remark}
