...
The difference is that for \(\mathcal{L} _1\), having an edge is \hyperref[not:quantifier-free-formula]{quantifier-free}, while in \(\mathcal{L} _2\) is \hyperref[not:existential]{existential}. To elaborate a bit further, for \(\mathcal{L} _2\), \(vEw\) is \hyperref[not:quantifier-free-formula]{quantifier-free}, while in \(\mathcal{L} _2\),
\[
