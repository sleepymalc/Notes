...
\begin{proof}\let\qed\relax
	...
	\begin{enumerate}[(a)]
		\item \(c^{\mathcal{M} } = [c]\).
		\item \(R^{\mathcal{M} }([c_1], \ldots , [c_n]) \) \hyperref[def:truth]{true} if \(R(c_1, \ldots , c_n)\) is in \(T\). This is well-defined by \autoref{A7} \autoref{def:axioms-for-equality-e}.
	...
	\[
		\mathcal{M} \models \varphi ([c_1], \ldots , [c_n]) \iff \varphi (c_1, \ldots , c_n) \text{ is in } T.
	\]
