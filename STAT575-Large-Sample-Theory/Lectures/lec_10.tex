\chapter{Fundamental Theorems of Probability and Applications to Inference}
\lecture{10}{15 Feb.\ 9:30}{WLLN and CLT}
\section{Weak Law of Large Number and Central Limit Theorem}
