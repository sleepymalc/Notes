...
\begin{note}
	Essentially, variance stabilizing transformation don't have any theoretical guarantees. Rather, it's just our guess that by making the variance independent of \(n\), it'll become better in terms of stability.
\end{note}