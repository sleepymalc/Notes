...
Another important mode of convergence is called \hyperref[def:weak-convergence]{weak convergence}, which we'll be primarily working with. Again, consider working with a probability space \((\Omega , \mathscr{F} , \mathbb{P} )\). First we see the following.
