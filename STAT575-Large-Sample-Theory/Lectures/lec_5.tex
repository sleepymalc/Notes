...
\begin{proof}
	...
	\[
		...
		= \lVert Y_n - c \rVert ,
	\]
	which goes to \(0\) \hyperref[def:convergence-in-probability]{in probability} as we wish. Combining both with \autoref{thm:converging-together} gives the result.
\end{proof}
