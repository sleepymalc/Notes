...
\begin{proof}
	...
	\]
	We want to show that the right-hand sides goes to \(0\) \hyperref[def:converge-in-probability]{in probability}. Observe that it's enough to show \(\lVert h(T_n) \rVert = o_p(1)\) and \(\lVert b_n (T_n - \theta ) \rVert \in O_p(1)\). Indeed:
	\begin{itemize}
