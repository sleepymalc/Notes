...
\begin{proof}
	...
	\begin{align*}
		...
		\shortintertext{with \(V_{\theta _k} \sim \mathop{\mathrm{Subg}}(1 / n) \) and \autoref{lma:lec7},}
...
\section{Glivenko-Cantelli Classes and Vapnik-Chervonenkis Dimension}
...
From \hyperref[prop:bracketing]{bracketing} and \hyperref[prop:symmetrization]{symmetrization}, we know that \(\mathscr{F} = \{ \mathbbm{1}_{-(-\infty , \theta ]} \colon \theta \in \mathbb{R} \} \) is \hyperref[def:Glivenko-Cantelli]{Glivenko-Cantelli}. Let's see some counterexamples.
